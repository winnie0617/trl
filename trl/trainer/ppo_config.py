...
class PPOConfig(object):
    ...
    wandb_name: Optional[str] = field(
        default='',
        metadata={"help": "Name for experiments"}
    )
    ...
    tracker_project_name: Optional[str] = field(
        default="trl-docker", metadata={"help": "Name of project to use for tracking"}
    )
    ...
    def __post_init__(self):
        ...
        if len(self.wandb_name):
            self.tracker_kwargs = {"wandb":{"name": self.wandb_name}}
